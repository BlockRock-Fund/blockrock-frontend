...
|---|---|
| **Passive Holders** | Enjoy increasing treasury-backed value with secure structure, bullish decision-making, and minimal value leakage. |
| **Active Investors** | Submit proposals, trade decision markets, and profit for accurate judgment. |
